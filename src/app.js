...
export default class {
  ...
  constructor(params, contentId, contentData = {}) {
    ...
    rootElement.classList.add('h5p-audio-recorder-book-maker');
    ...
    viewModel.$on('download', () => {
      recorder.getWavURL().then(url => {
        this.trigger('recordingdone', {id: this.bookmakerReferenceId, url: viewModel.audioSrc});
      });
    });
