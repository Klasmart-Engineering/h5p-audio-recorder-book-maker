<template>
  <div class="h5p-audio-recorder-book-maker-view">
    ...
    <div class="h5p-audio-recorder-book-maker-player" v-if="state === 'done' && audioSrc !== ''">
    ...
    <div v-if="state !== 'blocked' && state !== 'unsupported' && state === 'done'" class="h5p-audio-recorder-book-maker-download">
...
<style lang="scss" type="text/scss">
  ...
  .h5p-content:not(.using-mouse) .h5p-audio-recorder-book-maker-view .button:focus {
    @include blueGlow
  }

  .h5p-audio-recorder-book-maker-view {
    font-size: 1em;
    padding: 0.9em;
    text-align: center;
    ...
    .h5p-audio-recorder-book-maker-player {
    ...
    .h5p-audio-recorder-book-maker-download {
      font-size: 1.2em;
      padding: 2em;
    }
